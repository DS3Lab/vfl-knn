...
from utils.fagin_utils import suggest_size, count_by_arr_old
    ...
    def find_top_k(self, test_data, test_target, k):
        ...
        while cur_n_top < self.args.k and send_ind <= self.n_data:
            ...
            if rank == 0:
                ...
                count_by_arr_old(new_lists, counts, top_k, self.args.k)
        ...
        print("find top-k finish: target = {}, prediction = {}, total cost {:.2f} s, "
              ...
              "get candidates cost {:.2f} s, encryption cost {:.2f} s, "
              "comm candidate distance cost {:.2f} s, select top-k cost{:.2f} s"
              .format(test_target, pred_target, time.time() - start_time,
                      local_dist_time, sort_time, fagin_time, gather_time, bc_time, count_time,
                      candidate_time, encrypt_time, candidate_dist_time, select_top_time))
