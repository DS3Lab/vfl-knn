...
from transmission.tenseal.tenseal_shapley_schedule_client import ShapleyScheduleClient
...
class ShapleyFaginScheduleTrainer(object):
    ...
    def __init__(self, args, data, targets):
        ...
        self.clients = [ShapleyScheduleClient(address, args) for address in self.server_addrs]
