...
from transmission.tenseal.tenseal_shapley_client import ShapleyClient


class ShapleyFaginTrainer(object):
    ...
    def __init__(self, args, data, targets):
        ...
        self.clients = [ShapleyClient(address, args) for address in self.server_addrs]
