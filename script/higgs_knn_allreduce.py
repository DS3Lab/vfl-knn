...
from trainer.all_reduce_trainer import AllReduceTrainer
...
def run(args):
    ...
    trainer = AllReduceTrainer(args, train_dataset, train_targets)
    ...
    for i in range(args.n_test):
        ...
        pred_target = trainer.find_top_k(test_data, test_target, args.k)
