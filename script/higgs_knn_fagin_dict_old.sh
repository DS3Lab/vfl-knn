#!/bin/bash
# 10 machines
# ./higgs_knn_fagin_dict_old.sh 5 15 2 10 10 /home/jiangjia/datasets/HIGGS-parts-label/ bach11:25000
...
for i in $workers; do
  ...
  if [[ $i == "bach07" ]]
	then
	  ...
	  mkdir -p $dir_path
    rm -f $log_path
	  nohup python -u higgs_knn_fagin_dict_old.py --init-method tcp://$master_ip --rank 0 --world-size $world_size \
