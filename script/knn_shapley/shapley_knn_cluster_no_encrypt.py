...
from trainer.knn_shapley.shapley_cluster_trainer_no_encrypt import ClusterTrainer
...
def run(args):
    ...
    trainer = ClusterTrainer(args, train_data, train_targets)
    ...
    for group_key in range(start_key, end_key + 1):
        ...
        for i in range(args.n_test):
            ...
            pred_target, pred_prob = trainer.find_top_k(cur_test_data, cur_test_target, args.k, args.n_cluster, group_flags)
