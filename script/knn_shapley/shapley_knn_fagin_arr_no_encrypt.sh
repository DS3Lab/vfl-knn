...
# ./shapley_knn_fagin_arr_no_encrypt.sh world_size n_features n_classes k n_test root master_ip cluster_name dataset

# for higgs
# ./shapley_knn_fagin_arr_no_encrypt.sh 5 15 2 5 10 /home/jiangjia/datasets/HIGGS-parts-label/ bach03:24000 bach
# ./shapley_knn_fagin_arr_no_encrypt.sh 5 15 2 10 10 /home/jiangjia/datasets/HIGGS-parts-label-small/ bach03:24000 bach
...
# ./shapley_knn_fagin_arr_no_encrypt.sh 2 2 100 3 10000 /home/jiangjia/datasets/birch1-vertical/ bach03:24000 bach birch1
# ./shapley_knn_fagin_arr_no_encrypt.sh 2 2 100 5 10000 /home/jiangjia/datasets/birch2-vertical/ bach03:24000 bach birch2
# ./shapley_knn_fagin_arr_no_encrypt.sh 2 2 100 3 10000 /home/jiangjia/datasets/birch2-vertical/ bach03:24000 bach birch2
...
for i in "${machines[@]}"; do
  dir_path="${home_path}/logs/vfl-knn/${dataset}_shapley_fagin_arr_no_encrypt_w${world_size}_k${k}_t${n_test}/"
  ...
  if [[ $i == ${machines[0]} ]]
	...
	echo $node_name
  ssh $node_name "source $env_path; cd $code_path; nohup python3 -u shapley_knn_fagin_arr_no_encrypt.py --init-method tcp://$master_ip --rank $rank --world-size $world_size --root $root --n-features $n_features --n-classes $n_classes --k $k --n-test $n_test --no-cuda > $log_path 2>&1 &"
  rank=$(($rank+1))
