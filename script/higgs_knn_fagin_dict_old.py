...
sys.path.append("../")
from data_loader.data_partition import load_higgs_part_with_label
from trainer.fagin_dict_trainer_old import FaginDictTrainer
...
def run(args):
    ...
    trainer = FaginDictTrainer(args, train_dataset, train_targets)
    ...
    for i in range(args.n_test):
        ...
        cur_test_data = test_dataset[i]
        cur_test_target = test_targets[i]
        true_targets.append(cur_test_target)

        pred_target = trainer.find_top_k(cur_test_data, cur_test_target, args.k)
