#!/bin/bash
# 10 machines
# ./knn_allreduce.sh  /bigdata/dataset/cifar10_fc_fl/ bach07:24000
# ./knn_fagin_arr_old.sh 5 15 2 10 10 /home/jiangjia/datasets/higgs/HIGGS-parts-label/ bach11:25000
...
for i in $workers; do
  ...
  if [[ $i == "bach07" ]]
	then
	  ...
	  mkdir -p $dir_path
    rm -f $log_path
	  nohup python -u knn_fagin_arr_old.py --init-method tcp://$master_ip --rank 0 --world-size $world_size \
