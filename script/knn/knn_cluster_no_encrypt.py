...
from trainer.knn.cluster_trainer_no_encrypt import ClusterTrainer
...
def run(args):
    ...
    trainer = ClusterTrainer(args, train_dataset, train_targets)
    ...
    for i in range(args.n_test):
        ...
        pred_target, pred_prob = trainer.find_top_k(test_data, test_target, args.k, args.n_cluster)
