...
# ./lr_servers_launcher.sh 5 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config synthesis1K 5 10000 1 bach

# Bank, N=3200, D=8, C=2
# ./lr_servers_launcher.sh 4 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config bank 5 320 1 bach

# G2, N=2048, D=128/4, C=2
# ./lr_servers_launcher.sh 5 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config G2-128 5 20480 1 bach
# ./lr_servers_launcher.sh 4 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config G2-4 5 20480 1 bach

# birch1/birch1, N=100K, D=2, C=100
# ./lr_servers_launcher.sh 2 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config birch1 5 100000 1 bach
# ./lr_servers_launcher.sh 2 /home/jiangjia/code/vfl-knn/tenseal_script/ts_ckks.config birch2 5 100000 1 bach
...
for port in "${ports[@]}"; do
  for i in "${machines[@]}"; do
    ...
    dir_path="${home_path}/logs/vfl-lr/server/tenseal_${dataset}_k${k}_t${n_test}/"
